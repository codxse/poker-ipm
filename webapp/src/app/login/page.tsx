...
export default async function LoginPage({ searchParams }) {
  ...
  return (
    <main className="px-8 md:px-16 mt-12 md:mt-20 w-full md:w-3/4 mx-auto">
      <section className="flex flex-col md:flex-row gap-8 items-center">
        ...
        <LoginWithGoogleCard
          className="w-full md:w-1/2 bg-slate-400 dark:bg-slate-200 drop-shadow-2xl rounded-xl border-2 border-gray-500 dark:border-gray-300 h-40 md:h-80 flex flex-col items-center justify-center p-0 md:p-8 lg:p-16"
          session={session}
        />
      </section>
    </main>
